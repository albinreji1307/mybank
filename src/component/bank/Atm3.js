  ...
  render() {
    ...
    return (
     <div  style={{marginRight:"290px"}}>
      ...
      <div >
      <Nav/><br/><Link to="/Application" style={{color:"black",textDecoration:"none",marginLeft:"232px"}} ><Button variant="outlined">Back</Button></Link>
     
        <div className="terminal"  >
          <h2 className="balance" style={{marginRight:"950px"}}>
            YOUR BALANCE<br/><br/>
            ₹{} {balance.toFixed(2)}
          </h2>
          </div>
        ...
        <div className="terminal">
          <div className="custom-amount-container" style={{marginRight:"950px"}}>
          ...
          <Button
          style={{color:'black',marginRight:"950px"}}
            type="button"
            variant='outlined'
